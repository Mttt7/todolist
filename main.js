...
function drawTask(task){
    ...
    taskEl.classList.add('task-el')
        ...
        if(isNaN(task.date)) taskDate.textContent='no deadline'
            ...
            if((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(task.date,new Date())>72){
                
                taskDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(task.date,'do-LLL-yyyy')
            }
